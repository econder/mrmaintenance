		...
		public DataTable Load()
		{
			using(SqlConnection dbConn = new SqlConnection(connStr))
			{
				...
				SqlDataAdapter da = new SqlDataAdapter("SELECT dbo.Equipment.equipId, dbo.Locations.facId, dbo.Equipment.locId, dbo.Equipment.equipTypeId, dbo.Equipment.manId, dbo.Equipment.vendorId," + 
                                                        ...
                                                        " dbo.Equipment.hmiRuntimeTagname, dbo.Equipment.hmiRuntimeCont, dbo.Equipment.hmiCyclesTagname, dbo.Equipment.hmiCyclesCont," + 
                                                        " dbo.Equipment.equipMccLoc, dbo.Equipment.equipMccPanel" + 
		...
		public int Insert(Equipment equipment)
		{
			using(SqlConnection dbConn = new SqlConnection(connStr))
			{
				...
				try
				{
                    ...
                    cmd.Parameters.AddWithValue("@hmiRuntimeCont", equipment.HmiRuntimeContinuous);
                    ...
                    cmd.Parameters.AddWithValue("@hmiCyclesCont", equipment.HmiCyclesContinuous);
		...
		public int Update(Equipment equipment)
		{
			using(SqlConnection dbConn = new SqlConnection(connStr))
			{
				...
				SqlCommand cmd = new SqlCommand("UPDATE Equipment SET locId=@locId, equipTypeId=@equipTypeId, manId=@manId, vendorId=@vendorId, modelId=@modelId, equipNumber=@equipNumber, equipName=@equipName," +
				                                " descr=@descr, equipSerial=@equipSerial, hmiRuntimeTagname=@hmiRuntimeTagname, hmiRuntimeCont=@hmiRuntimeCont, hmiCyclesTagname=@hmiCyclesTagname, hmiCyclesCont=@hmiCyclesCont," + 
                                                " equipMccLoc=@equipMccLoc, equipMccPanel=@equipMccPanel" +
